...
const VerifyCode = ({ navigation, route }) => {
	...
	return (
		<View style={styles.container}>
			...
			<Text style={styles.message}>Enter the 6 digits code that you received on your email</Text>
			...
			<SaveButton onPress={handleVerifyCode} title="Continue" style={styles.continueButton} />
		</View>
	);
};
