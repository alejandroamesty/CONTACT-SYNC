				...
				if (response.status === 200) {
					response
						...
						.then((fetchedContact) => {
							...
							const phoneTypes = contact.phones.map((phone) => phone.phone_type);
							const emailTypes = contact.emails.map((email) => email.email_type);
				...
				modalContent={
					<View style={styles.modalContentContainer}>
						<View style={styles.carouselContainer}>
							<Carousel letter={firstName ? firstName[0].toUpperCase() : "?"} defaultColor={colorMapping[color]} />
						</View>
						<FlatList
							style={styles.list}
							ListHeaderComponent={
